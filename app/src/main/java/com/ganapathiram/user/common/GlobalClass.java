package com.ganapathiram.user.common;

import android.app.Application;
import android.content.Context;


import com.ganapathiram.user.database.DaoMaster;
import com.ganapathiram.user.database.DaoSession;
import com.ganapathiram.user.database.Product;
import com.ganapathiram.user.helper.Helper;
...
public class GlobalClass extends Application{
    ...
    public void onCreate() {
        ...
        super.onCreate();
        DaoMaster.DevOpenHelper helper = new DaoMaster.DevOpenHelper(this, "grapp_db");
